...
- ソフトウェア・カーペントリーとは何でしょうか？ What is Software Carpentry (SWC)?

- SWCに参加すると何が得られるでしょうか？ What can you gain from participating in SWC?

- どうやってSWCの教材を日本語にしているのか？ How are we translating SWC materials in Japanese?
...
Harvard University, 2015: クラスターを使うのに必須<br>Required to use computing cluster (Software Carpentry)

Smithsonian Institution, 2019: 博物館の研究者にデータ解析スキルを教える<br>Teach museum researchers analysis skills (Data Carpentry)

Institute for Tribal Environmental Professionals, 2020: アメリカ先住民の方々にデータスキルを教える<br>Teach tribal leaders analysis skills (Data Carpentry)
